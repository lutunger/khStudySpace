...
function testFn(){
    ...
    console.log("함수 내부에서 선연된 (함)num3 : " + num3);
    console.log("함수 내부에서 선연된 (전)num4 : " + num4);
...
// console.log("함수 밖에서 선연된 (함)num3 : " + num3);

// JS 코드가 중간에 에러가 발생하면 
// 같은 파일/함수 내 에러 이후 부분 코드가 해석되지 않는다.
console.log("함수 밖에서 선연된 (전)num4 : " + num4);
...
const temp = 999;
// temp = 1000; // Assignment to constant variable.
