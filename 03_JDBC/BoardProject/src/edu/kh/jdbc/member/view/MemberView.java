...
/** 회원 전용 화면
 * @author 김지환(lutungerst@gmail.com)
 */
...
//					Terminates the currently running Java Virtual Machine.
	...
	private void updateMember() {
		...
		try {
			...
			// Session.loginMember.getMemberId() : 로그인한 회원의 번호
	...
	private void updatePassword() {
		...
		while(true) {
			...
			// 아닐 때
			System.out.println("새 비밀번호 입력이 맞지 않습니다. 다시 입력해주세요.");
		}
		...
		try {
			...
			int result = service.updatePassword(curPass, newPass, 
												Session.loginMember.getMemberNo());
