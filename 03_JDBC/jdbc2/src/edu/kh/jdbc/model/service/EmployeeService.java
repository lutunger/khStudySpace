...
public class EmployeeService {
	...
	public List<Employee> selectAll() throws SQLException{
		...
		// ** DML 구문인 경우 해당위치에 commit/rollback 구문 작성
	...
	public List<Employee> searchSalary(int min, int max) throws SQLException {
		
		Connection conn = getConnection();
		
		List<Employee> empList = dao.searchSalary(conn, min, max);
