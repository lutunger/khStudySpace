...
public class MethodExView {
	...
	public void displayMenu() { // 메뉴 표시(출력) 기능
		...
		do {
			System.out.println("--------------------");
			System.out.println("1. 매개변수 X, 반환 값X");
			System.out.println("2. 매개변수 O, 반환 값X");
			System.out.println("3. 매개변수 X, 반환 값O");
			System.out.println("4. 매개변수 O, 반환 값O");
	...
	public void menu2() {
		...
		System.out.println("[정수 3개를 입력 받아 합계를 출력]");
