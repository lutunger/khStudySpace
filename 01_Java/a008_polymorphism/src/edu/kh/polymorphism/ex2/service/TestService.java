...
public class TestService {
	...
	public void ex1() {
		...
		// Animal a = new Animal();
		// Cannot instantiate(객체화) the type Animal : 객체화 할 수 없는 타입이다.
		// -> 추상 클래스이기 때문에!
...
//		System.out.println(cal.multiple(2, 2));
//		System.out.println(cal.divide(2,2));
//		System.out.println(cal.divide2(2,2));
//		System.out.println(cal.areaOfCircle(2.0));
//		System.out.println(cal.sqaure(2, 2));
	}
