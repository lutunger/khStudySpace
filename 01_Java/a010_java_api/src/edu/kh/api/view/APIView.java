...
public class APIView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				case 8 : ex8(); break;
				case 0 : break;
				default : System.out.println("메뉴에 존재하는 번호만 입력 해주세요."); break;
				}
	...
	public void ex2() {
		...
		Student[] result = service.selectName(input);
...
//		System.out.println(s2.hashCode());
		...
		// Sytem.identityHashCode(객체주소)
		// -> 객체주소를 이용해서 만든 정수를 변환
		System.out.println("s1 : " + System.identityHashCode(s1));
		System.out.println("s2 : " + System.identityHashCode(s2));
		System.out.println("s3 : " + System.identityHashCode(s3));

		// s3가 참조하는 STirng 객체의 값 변경
		// "abc"
		s3 += "def"; //"abcdef"
	...
	private void ex5() {
		...
		// delete(int satrt, int end) : 삭제(start이상 end 미만)
		sb.delete(3, 5); // ab@'cd'ef ,, 끝에 인덱스에는 베타적이네(끝은 포함이 안되는 경우가 많다.)
	...
	private void ex7() {
		...
		System.out.println(Integer.SIZE); // bit 단위 크기 = 4 * 8 = 32
		...
		// valueOf -> 밸류를 필드에 넣는다
		// valueof -> tostring => 필드에 넣어진 밸류를 string 형태로 반환한다.
		String str2 = 999 + "";
