...
public class OperatorEx2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("++numb3 : " + (++num3)); // num3 = 6
//	    증가하거나 감소한 값이 그대로 변수에 있다.
		// 현재 num3 = 6
		System.out.println("--num3 + 10 : " + (--num3 + 10)); // --num3 + 10 = 15
		// --num3 + 10
		// (6-1) + 10 = 15
...
//						   num4-- : 1  -> num4 = 0
		...
		System.out.println( 5 % 2 == 0 ); // false // 1 과 0은 같지 않아!
		...
		System.out.println("463984는 3의 배수인가? : " + (463974 % 3 == 0) );
		System.out.println("463984는 3의 배수인가? : " + (463974 % 4 == 0) );
