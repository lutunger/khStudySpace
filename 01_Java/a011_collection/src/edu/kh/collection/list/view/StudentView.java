...
//		selfwrite code below
//		System.out.print("조회할 학년을 입력하세요 : ");
//		int searchInput = sc.nextInt();
//		
//		List<Student> list = service.selectGrade(searchInput);
//			
//		if(list.isEmpty()) {
//			System.out.printf("%d학년 학생이 존재하지 않습니다", searchInput);
//		}else {
...
//		while(!spellChecker) {
//		System.out.print("조회할 성별을 입력하세요(M/F) : ");
//		genderInput = sc.nextLine().toUpperCase().charAt(0);
//
//		
...
//		}
//		
//		List<Student> list = service.selectGender(genderInput);
//		
//		if(genderInput == 'M') {
...
//		}
//		for(Student s : list) {
//			System.out.printf("%d학년 %d반 %2d번 %s(%c) %n",
//								s.getGrade(),
//								s.getClassRoom(),
//								s.getNumber(),
//								s.getName(),
