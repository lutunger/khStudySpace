...
public class StudentService {
	...
	// Student 객체 참조변수 5개짜리 배열을 생성하서 studentArr 참조
	...
	public StudentService() {
		...
		studentArr[1] = new Student(1, 3, 11, "김철수");
...
//		}
//		
//		int[] studentSumArr = new int[notNullLength];
//		
...
//		
//		// arr[0]  점수 합계
//		for (int i = 0; i < studentSumArr.length; i++) {
//			arr[0] += studentSumArr[i];
//		}
//			
//		// arr[1]  점수 평균
//		arr[1] = arr[0] / studentSumArr.length;
//		
//		// arr[2] 점수 최고점
//		int highScore = -1;
//		for(int i = 0; i < studentSumArr.length; i++) {
//			if(studentSumArr[i]>highScore) {
//				highScore = studentSumArr[i];
//			}
//		}
//		arr[2] = highScore;
//		
...
//		int lowScore = 1000;
//		for(int i = 0; i < studentSumArr.length; i++) {
//			if(studentSumArr[i]<lowScore) {
//				lowScore = studentSumArr[i];
//			}
//		}
//		arr[3] = lowScore;
//		
