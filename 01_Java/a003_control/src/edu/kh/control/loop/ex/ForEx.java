	...
	public class ForEx {
		 ...
		 *  
		 *  - 초기식 : for문을 제어하는 용도의 변수를 선언 및 초기화(변수에 값을 처음(초기) 대입하는거~)
		 *  
	...
	//		int requestInputNumber = sc.nextInt();
	//		
	//		int sum = 0;
	//		
	//		if(requestInputNumber < 1) {
	//			System.out.println("입력 받을 정수는 1개 이상이여야 합니다");
	//		} else {
	//			for(int i = 1; i <= requestInputNumber; i++) {
	//				System.out.printf("입력 %d : ", i);
	//				sum += sc.nextInt();
	//			}
	//		}
	...
	//		
		...
		public void ex13() {
			...
			int multiplierInput = sc.nextInt();
		...
		public void ex14() {
			...
			if((multiplierInput < 2) || (multiplierInput > 9)) {
