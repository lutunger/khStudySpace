...
//		}
	...
	public void ex3() {
		...
		case "떡뽂이" : 	price = 4000; break;
		default : price = -1; // 잘못 입력한 경우에 사용하지 않는 숫자(-1)을 이용해서 표현
	...
	public void ex4() {
		...
		int integerOperend1 = sc.nextInt();
		...
		int integerOperend2 = sc.nextInt();
		...
		case "+" : System.out.printf("%d + %d = %d",
									integerOperend1,
									integerOperend2,
									integerOperend1 + integerOperend2
									);
					break;
		...
		case "/" : if(integerOperend2 == 0) {
					System.out.println("0으로는 나눌 수 없습니다.");
					}else {
					System.out.printf("%d / %d = %.3f",
									integerOperend1,
									integerOperend2,
									(double)integerOperend1 / integerOperend2
									);
					}
					break;
