...
//		ch = 'AA'; // char 자료형은 '' 안에 문자 하나만 작성 가능
		...
		// int : 10, -50, 0 (기본 정수 표기법), max_value : 2147483647(2147483648 -> overvalue)
		// long : 2147483648L, 0L, -10L (l, L)
		
		// double : 3.14, -123.456, 0.0 
		// (기본 실수 표기법, 모두 실수 형태(point)로 작성)
...
//		float number4 = 1.23; // complie error
		...
		byte number5 = 100;
		short number6 = 200;
		// byte, short는 int표기법 사용(옛날 자료형이라서 f, L과 같은 다른 표기법을 쓰진 않는다)
