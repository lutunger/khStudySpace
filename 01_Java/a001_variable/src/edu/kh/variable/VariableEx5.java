...
public class VariableEx5 {
	public static void main(String[] args) {
		...
		// ch5에 백, ㄱ 도 대입하면 백, ㄱ에 해당하는 유니코드 넘버를 구할 수 있다..
...
//		   주의사항 : 인텔 내부 그래픽 드라이버 단축키랑 겹쳐서 실행이 안 될 수 있다(화면 회전 단축키)
		
		
		
		// 강제 형변환 확인 2 : 소수 버림(내림과는 다르다)
		double test3 = -1.3;
		int test4 = (int)test3;
		...
		System.out.println(iNum3); //-1294967296
