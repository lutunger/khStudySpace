...
public class MyPageServiceImpl implements MyPageService{
	...
	@Value("${my.member.webpath}") // properties 값 꺼내올때 씀
   ...
   // @Transactional의 rollbackFor 속성을 활용하면 된다
	...
	// 비밀번호 변경 서비스
	//@Transactional // UnChecked Exception 발생 시 rollback --> spring은 거진 모든 예외를 unChecked로 돌려서 이거 쓰면된다..
	
	@Transactional(rollbackFor = Exception.class) // 모든 Exception(checked + unchecked) 발생 시 rollback
	@Override
