...
btn2.addEventListener('click', () => {
    ...
    // POST 방식 비동기 요청
    fetch("/selectMember", {
        method : "POST", /* method에 '' 생략 -> 무조건 key니까? */
...
// 이메일이 일부라도 일치하는 모든회원 조회(조회는 대부분 get)
