    ...
    if(   regEx.test(memberEmail.value)   ){ // 유효한 경우
        ...
        .then(count => {
            ...
            if(count == 0){
                ...
                emailMessage.classList.remove("error"); // css에 .error 스타일 적용
                ...
                emailMessage.classList.remove("confirm"); // css에 .error 스타일 적용
        ...
        emailMessage.classList.remove("confirm"); // css에 .confirm 스타일 적용
