...
//	@Scheduled(cron = "0 0 * * * *") // 매 정시( *시 0분 0초)
	public void test() {
		...
		// /resourecs/images/board의 실제 서버 경로를 얻어옴
		String filePath = servletContext.getRealPath("/resources/images/board");
		// C:\work_space\06_Framework\boardProject\src\main\webapp\resources\images\board
		// window => \
		// mac, unix => /
 ...
 * 7(SAT) ex) 2019년 9월 16일 월요일 10시 30분 20초 cron="20 30 10 16 9 2 2019" // 연도 생략
 * 가능
 * 
