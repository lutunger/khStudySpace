...
DROP TABLE "MEMBER"; -- 혹시나 테이블 갈아엎을일이 있으면...
...
--ERDCLOUD는 체크 제약조건 추가가 안되서 따로 추가해줘야한다
...
INSERT INTO "BOARD_TYPE" VALUES(
	SEQ_BOARD_CODE.NEXTVAL, '공지사항'
)
;

INSERT INTO "BOARD_TYPE" VALUES(
	SEQ_BOARD_CODE.NEXTVAL, '자유 게시판'
)
;

INSERT INTO "BOARD_TYPE" VALUES(
	SEQ_BOARD_CODE.NEXTVAL, '테스트 게시판'
)
;

INSERT INTO "BOARD_TYPE" VALUES(
	SEQ_BOARD_CODE.NEXTVAL, '질문 게시판'
)
;

INSERT INTO "BOARD_TYPE" VALUES(
	SEQ_BOARD_CODE.NEXTVAL, '점심 게시판'
)
;
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 1997);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 1991);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 1993);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 1989);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 1988);
...
-- 마이바티스 X
-- 1~10행 조회
-- ROWNUM은 WHERE절에 사용될 때 1행이 조건에 포함되어야 한다.(가상컬럼이라서 1부터 시작해야 인식한다.)
--		-> ROWNUM에 별칭지정 -> 더 이상 가상컬럼이 아니게 됨
SELECT * FROM(
...
-- 게시글 좋아요 샘플데이터 삽입
INSERT INTO "BOARD_LIKE" VALUES(1997, 1);
INSERT INTO "BOARD_LIKE" VALUES(1997, 3);
INSERT INTO "BOARD_LIKE" VALUES(1997, 4);
COMMIT;

-- 특정 게시글의 좋아요 개수 카운트
SELECT COUNT(*) 
FROM "BOARD_LIKE" L
WHERE L.BOARD_NO = 1997;

SELECT * FROM BOARD_IMG;


-- 특정 게시글에 존재하는 이미지(IMG_ORDER 오름차순)
SELECT * FROM BOARD_IMG
WHERE BOARD_NO = 1997
ORDER BY IMG_ORDER;
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/yes.png'
WHERE MEMBER_NO = 1;
...
--> 시퀀스 생성 구문을 작성하지 못함 (탈락) --> 시퀀스 없으면 INSERT ALL 쓰면 된다.
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 2008, 1, NULL)	 
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 2008, 3, NULL)	 
;

-- 1001, 1002, 1003

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 2008, 3, 1001)	 
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 2008, 3, 1001)	 
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 2008, 3, 1001)	 
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 2008, 3, 1002)	 
;


INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 2008, 3, 1002)	 
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글 2-1-1', DEFAULT, DEFAULT, 2008, 3, 1007)	 
;

COMMIT;

				/*누구부터 시작? 상위타입 지정 누가 부모냐*/ 
				/*부모 자식사이를 어떻게 연결할거냐*/
				/*형제 자매 순서 어떻게 할까?*/
/* 계층형 쿼리(START WITH, CONNET BY, ORDER SIBLINGS BY)   
