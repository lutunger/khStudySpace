...
-- 주어진 문자열의 앞쪽|뒤쪽|양쪽에 존재하는 지정된 문자열를 제거
...
SELECT 123.456,
	...
	ROUND(123.456,  1), -- 소수점 첫째 자리까지 표현(->둘째 자리에서 반올림)
	ROUND(123.456,  2), -- 소수점 둘째 자리까지 표현
	ROUND(123.456,  0), -- 소수점 0번째 자리까지 표현 -> 정수 (첫번째 컬럼이랑 같다)
...
-- 2023-03-07 12:22:44.000 , 2023-03-07 12:22:44.971 +0900


----------------------------------------------------------------
-- MONTH_BETWEEN(날짜, 날짜) :
SELECT MONTHS_BETWEEN('2023/07/14', '2023/02/06')
FROM DUAL;
...
SELECT EMP_NAME, HIRE_DATE
	...
	, CEIL(MONTHS_BETWEEN(SYSDATE, HIRE_DATE) / 12) "근무 N차"
...
SELECT LAST_DAY(SYSDATE), LAST_DAY('2023/04/01'), LAST_DAY('2023/04/01') + 1
FROM DUAL;
 ...
 * 3) L : locale(지역), 현재 시스템이나 DB에 설정된 나라의 화폐 기호
 * 4) , : 숫자의 자릿수 구분
 * */
...
SELECT 10000000,
	TO_CHAR(1000000, 'L9999999'), -- ￦10000000
	TO_CHAR(1000000, '$9999999'),  --  $10000000
...
SELECT TO_DATE('2023년 03월 07일', 'YYYY'"년" MM'"월" DD"일"'ㅇ) 
FROM DUAL;
